        ...
        <div className="mainContainer">
            ...
            <div className="bg-gray-100 py-8">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <p className="text-lg text-gray-700 mb-8">Our web application streamlines inventory management and
                        technician assignments for campus clusters. By automating location assignments based on factors
                        ...
                        PostgreSQL, and Flask, our app empowers users at every level to efficiently manage inventory and
                        assignments.</p>
                </div>
            </div>
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Meet Our Team</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <img src={process.env.PUBLIC_URL + 'David_Nyakawa_photo.png'} alt="Profile 1" className="w-300 h-320 rounded-full mx-auto mb-4" />
