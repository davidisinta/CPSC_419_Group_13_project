...
class Connection:
    ...
    def get_summary(self):
        ...
        query = """SELECT p.id, 
                ...
                JOIN toner_inventory ti ON l.id = ti.loc_id
                LEFT JOIN toner t ON t.id = ti.toner_id
                JOIN toner_inventory wi ON l.id = wi.loc_id
                LEFT JOIN toner wt ON wt.id = wi.toner_id
                WHERE t.color <> 4 and wt.color = 4
...
#     con.stock_toner('36', '2', '4')
#     con.stock_toner('36', '77', '0')
